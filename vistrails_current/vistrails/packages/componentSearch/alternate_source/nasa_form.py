...
#        model.setHeaderData(3, Qt.Horizontal, QVariant("Version"))
    ...
    def _show_mashups(self, mashups):
        ...
        for mashup in mashups:
            ...
            model.setData(model.index(row, 1), QVariant(mashup['_id']))
            model.setData(model.index(row, 2), QVariant(mashup['dataset']))
            model.setData(model.index(row, 3), QVariant(mashup['link']))
